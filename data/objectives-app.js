...
const E = {
  ...
  "1.1.f": {
    ...
    prereqs: [],
    resources: [
      {"type":"video","title":"PowerCert — What is a Router?","url":"https://www.youtube.com/watch?v=1z0ULvg_pW8","desc":"Covers endpoints as they connect through routers and switches"},
      {"type":"video","title":"Jeremy's IT Lab — CCNA Network Devices","url":"https://www.youtube.com/playlist?list=PLxbwE86jKRgMpuZuLBivzlM8s2Dk5lXBQ","desc":"Full CCNA course Day 1 — routers, switches, firewalls, APs, WLC"},
      {"type":"article","title":"NetworkLessons — Routers and Routing Introduction","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-routers-and-routing","desc":"Written guide covering router fundamentals and basic configuration"}
    ],
    labs: [],
    vocab: [
  ...
  "1.1.g": {
    ...
    prereqs: [],
    resources: [
      {"type":"video","title":"PowerCert — What is a Router?","url":"https://www.youtube.com/watch?v=1z0ULvg_pW8","desc":"Covers server roles (DHCP, DNS, web) in network context"},
      {"type":"video","title":"Jeremy's IT Lab — CCNA Network Devices","url":"https://www.youtube.com/playlist?list=PLxbwE86jKRgMpuZuLBivzlM8s2Dk5lXBQ","desc":"Full CCNA course Day 1 — routers, switches, firewalls, APs, WLC"},
      {"type":"article","title":"NetworkLessons — Routers and Routing Introduction","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-routers-and-routing","desc":"Written guide covering router fundamentals and basic configuration"}
    ],
    labs: [],
  ...
  "1.2.e": { difficulty: 15, studyTime: 10, examFreq: 35, why: "SOHO is a simple flat network. Know it uses a single combo device.", ciscoIntent: "Identify SOHO network characteristics", cheatSheet: [{ heading: "SOHO", items: ["Small office / home office — typically < 10 users", "Single combo device: router + switch + AP + firewall + DHCP server", "Flat network — one subnet, one broadcast domain", "ISP uplink via DSL, cable, or fiber modem", "Examples: home WiFi router, small business gateway"]}], prereqs: [], resources: [
      {"type":"video","title":"Campus Network Design","url":"https://www.youtube.com/watch?v=zbqrNg4C98U","desc":"Includes SOHO as the simplest flat-network topology"},
      {"type":"article","title":"NetworkLessons — Campus Network Design","url":"https://networklessons.com/cisco/ccna-200-301/cisco-campus-network-design-basics","desc":"Two-tier, three-tier, and spine-leaf architecture explained"},
      {"type":"article","title":"NetworkLessons — Spine-and-Leaf Architecture","url":"https://networklessons.com/cisco/ccna-200-301/spine-and-leaf-architecture","desc":"Data center fabric design — why every leaf connects to every spine"}
    ], labs: [], vocab: [{ term: "SOHO", q: "What typically characterizes a SOHO network?", options: ["Multi-building campus", "Single all-in-one device (router/switch/AP/firewall)", "Spine-leaf DC architecture", "Dedicated distribution switches"], answer: 1, explain: "SOHO networks use a single combo device that integrates routing, switching, wireless, NAT, and DHCP for a small number of users." }] },
  ...
  "1.9.b": { difficulty: 35, studyTime: 15, examFreq: 35, why: "Anycast is the same address assigned to multiple devices — traffic goes to the nearest one.", ciscoIntent: "Explain anycast addressing", cheatSheet: [{ heading: "Anycast", items: ["Same IPv6 address assigned to multiple interfaces/devices", "Routed to the nearest device (by routing protocol metrics)", "No special prefix — uses global unicast address range", "Used for load balancing and redundancy (e.g., DNS root servers)"]}], prereqs: [{ name: "Unicast types", obj: "1.9.a" }], resources: [
      {"type":"video","title":"IPv6 Address Types","url":"https://www.youtube.com/watch?v=V6LC_ISNKC0","desc":"Anycast — same address on multiple devices, nearest wins"},
      {"type":"article","title":"NetworkLessons — IPv6 Address Types","url":"https://networklessons.com/cisco/ccna-200-301/ipv6-address-types","desc":"Global unicast, unique local, link-local, multicast, anycast"},
      {"type":"article","title":"NetworkLessons — Solicited-Node Multicast","url":"https://networklessons.com/cisco/ccna-200-301/ipv6-solicited-node-multicast-address","desc":"How NDP uses solicited-node multicast for neighbor discovery"},
      {"type":"article","title":"NetworkLessons — EUI-64 Explained","url":"https://networklessons.com/cisco/ccna-200-301/ipv6-eui-64-explained","desc":"How interface IDs are derived from MAC addresses"}
    ], labs: [], vocab: [{ term: "Anycast", q: "How does anycast differ from unicast?", options: ["Anycast addresses multiple devices but routes to the nearest one", "Anycast goes to all devices simultaneously", "Anycast only works on link-local", "There's no difference"], answer: 0, explain: "Anycast assigns the same address to multiple devices. The routing protocol delivers the packet to the topologically nearest one." }] },
  "1.9.c": { difficulty: 35, studyTime: 15, examFreq: 45, why: "Multicast replaces broadcast in IPv6. Know key multicast addresses: FF02::1 (all nodes), FF02::2 (all routers).", ciscoIntent: "Identify common multicast addresses and their scope", cheatSheet: [{ heading: "Multicast", items: ["FF00::/8 — all multicast addresses start with FF", "FF02::1 — all nodes on the local link", "FF02::2 — all routers on the local link", "FF02::5 — all OSPF routers", "FF02::6 — all OSPF DRs", "IPv6 has NO broadcast — multicast replaces it"]}], prereqs: [{ name: "Unicast types", obj: "1.9.a" }], resources: [
      {"type":"video","title":"IPv6 Address Types","url":"https://www.youtube.com/watch?v=V6LC_ISNKC0","desc":"Multicast — FF00::/8, replaces broadcast in IPv6"},
      {"type":"article","title":"NetworkLessons — IPv6 Address Types","url":"https://networklessons.com/cisco/ccna-200-301/ipv6-address-types","desc":"Global unicast, unique local, link-local, multicast, anycast"},
      {"type":"article","title":"NetworkLessons — Solicited-Node Multicast","url":"https://networklessons.com/cisco/ccna-200-301/ipv6-solicited-node-multicast-address","desc":"How NDP uses solicited-node multicast for neighbor discovery"},
      {"type":"article","title":"NetworkLessons — EUI-64 Explained","url":"https://networklessons.com/cisco/ccna-200-301/ipv6-eui-64-explained","desc":"How interface IDs are derived from MAC addresses"}
    ], labs: [], vocab: [{ term: "Multicast", q: "IPv6 multicast for all nodes on local link?", options: ["FF02::1", "FF02::2", "FE80::1", "2001::1"], answer: 0, explain: "FF02::1 reaches all nodes on the local link. FF02::2 reaches all routers." }] },
  ...
  "1.9.e": { difficulty: 40, studyTime: 20, examFreq: 50, why: "Solicited-node multicast ties directly into NDP neighbor solicitation. Cisco tests how IPv6 replaces ARP.", ciscoIntent: "Explain how solicited-node multicast enables efficient neighbor discovery", cheatSheet: [{ heading: "Solicited-Node Multicast", items: ["Format: FF02::1:FFxx:xxxx (last 24 bits from unicast address)", "Auto-generated for every unicast and anycast address on the interface", "Used by NDP Neighbor Solicitation (NS) instead of ARP broadcast", "Only devices with matching last 24 bits process the packet — far more efficient than broadcast", "Replaces ARP's broadcast-to-all approach with targeted multicast"]}], prereqs: [{ name: "IPv6 multicast", obj: "1.9.c" }, { name: "NDP", obj: "1.8.g" }], resources: [
      {"type":"article","title":"NetworkLessons — Solicited-Node Multicast","url":"https://networklessons.com/cisco/ccna-200-301/ipv6-solicited-node-multicast-address","desc":"How solicited-node multicast addresses are formed and used by NDP"},
      {"type":"article","title":"NetworkLessons — IPv6 NDP","url":"https://networklessons.com/cisco/ccna-200-301/ipv6-neighbor-discovery-protocol-on-cisco-router","desc":"Neighbor Discovery Protocol — RS, RA, NS, NA replacing ARP"},
      {"type":"video","title":"IPv6 Address Types","url":"https://www.youtube.com/watch?v=V6LC_ISNKC0","desc":"Multicast address types including solicited-node"}
    ], labs: [], vocab: [{ term: "Solicited-node multicast", q: "How many bits of the unicast address appear in a solicited-node multicast address?", options: ["8 bits", "16 bits", "24 bits (last 24)", "48 bits"], answer: 2, explain: "The last 24 bits of the unicast address are appended to FF02::1:FF to form the solicited-node multicast address." }] },

  // ── 1.10 (no subs) ──────────────────────────────────────────────
  "1.10": { difficulty: 15, studyTime: 10, examFreq: 30, why: "Know the right command for each OS to verify IP configuration.", ciscoIntent: "Verify IP config on Windows, Mac OS, Linux", cheatSheet: [{ heading: "OS Commands", items: ["Windows: <code>ipconfig</code>, <code>ipconfig /all</code>", "macOS: <code>ifconfig</code>, <code>networksetup -getinfo Wi-Fi</code>", "Linux: <code>ip addr show</code> (modern), <code>ifconfig</code> (legacy)", "All: <code>ping</code>, <code>traceroute</code>/<code>tracert</code>, <code>nslookup</code>"]}], prereqs: [{ name: "IPv4 addressing", obj: "1.6" }], resources: [
      {"type":"video","title":"Troubleshooting Interface Errors","url":"https://www.youtube.com/watch?v=gXnKasnLsP8","desc":"Verifying IP parameters across Windows, Linux, and macOS"},
      {"type":"article","title":"NetworkLessons — Troubleshooting Interfaces","url":"https://networklessons.com/cisco/ccna-200-301/troubleshooting-interfaces","desc":"Verifying IP parameters with show commands on Cisco and client OS"}
  ...
  "1.11.b": { difficulty: 15, studyTime: 10, examFreq: 40, why: "SSID is the network name clients see. Know BSS vs ESS.", ciscoIntent: "Explain SSID and service set concepts", cheatSheet: [{ heading: "SSID", items: ["SSID = Service Set Identifier — the network name", "BSS = Basic Service Set (single AP + its clients)", "ESS = Extended Service Set (multiple APs, same SSID = roaming)", "SSID can be hidden (not broadcast) but still discoverable via probe"]}], prereqs: [], resources: [
      {"type":"video","title":"WiFi Channels Explained","url":"https://www.youtube.com/watch?v=59x4aBB0xBs","desc":"SSID — network name broadcast by AP"},
      {"type":"article","title":"NetworkLessons — Introduction to Wireless Networks","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-wireless-networks","desc":"RF fundamentals, channels, frequency bands, interference"},
      {"type":"article","title":"NetworkLessons — Wireless Security","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-wireless-security","desc":"WEP, WPA, WPA2, WPA3 — encryption and authentication methods"}
    ], labs: [], vocab: [{ term: "SSID", q: "Multiple APs with the same SSID form a...?", options: ["Conflict", "Extended Service Set (ESS)", "Mesh network", "Bridge"], answer: 1, explain: "Multiple APs with the same SSID form an ESS, enabling seamless roaming." }] },
  ...
  "1.13.b": { difficulty: 25, studyTime: 15, examFreq: 50, why: "Know what a switch does with known unicast frames vs unknown unicast.", ciscoIntent: "Describe how a switch forwards frames", cheatSheet: [{ heading: "Frame Switching", items: ["Known unicast — destination MAC in table → forward out mapped port only", "Unknown unicast — destination MAC NOT in table → flood all ports except ingress", "Switch methods: store-and-forward (checks CRC) vs cut-through (forwards immediately after reading dest MAC)"]}], prereqs: [{ name: "MAC learning", obj: "1.13.a" }], resources: [
      {"type":"video","title":"How Switches Work","url":"https://www.youtube.com/watch?v=9eH16Fxeb9o","desc":"Known unicast — forwarded out correct port only"},
      {"type":"article","title":"NetworkLessons — How Does a Switch Learn MAC Addresses?","url":"https://networklessons.com/cisco/ccna-200-301/how-does-a-switch-learn-mac-addresses","desc":"MAC learning, frame forwarding, flooding, and aging"},
      {"type":"article","title":"NetworkLessons — Collision and Broadcast Domains","url":"https://networklessons.com/cisco/ccna-200-301/collision-domains","desc":"How switches create separate collision domains per port"}
    ], labs: [], vocab: [{ term: "Known unicast", q: "Switch has dest MAC in table. What happens?", options: ["Floods all ports", "Forwards only to the mapped port", "Drops the frame", "Sends to gateway"], answer: 1, explain: "Known unicast = dest MAC found in MAC table → switch forwards out only the port associated with that MAC." }] },
  "1.13.c": { difficulty: 25, studyTime: 15, examFreq: 50, why: "Flooding is how switches handle unknown destinations, broadcasts, and multicast (without IGMP snooping).", ciscoIntent: "Identify when a switch floods frames", cheatSheet: [{ heading: "Frame Flooding", items: ["Unknown unicast — dest MAC not in table. Flood all ports in VLAN except ingress.", "Broadcast — dest = FF:FF:FF:FF:FF:FF. Always flooded.", "Multicast — flooded unless IGMP snooping is configured", "Flooding ensures the destination eventually receives the frame and replies (allowing the switch to learn its port)"]}], prereqs: [{ name: "Frame switching", obj: "1.13.b" }], resources: [
      {"type":"video","title":"How Switches Work","url":"https://www.youtube.com/watch?v=9eH16Fxeb9o","desc":"Flooding — unknown unicast, broadcast, multicast to all ports"},
      {"type":"article","title":"NetworkLessons — How Does a Switch Learn MAC Addresses?","url":"https://networklessons.com/cisco/ccna-200-301/how-does-a-switch-learn-mac-addresses","desc":"MAC learning, frame forwarding, flooding, and aging"},
      {"type":"article","title":"NetworkLessons — Collision and Broadcast Domains","url":"https://networklessons.com/cisco/ccna-200-301/collision-domains","desc":"How switches create separate collision domains per port"}
    ], labs: [], vocab: [{ term: "Unknown unicast", q: "What does a switch do with an unknown unicast frame?", options: ["Drops it", "Sends back to source", "Floods out all ports except ingress", "Sends to default gateway"], answer: 2, explain: "Unknown unicast = flood out all ports in the VLAN (except ingress) so the destination eventually gets it." }] },
  "1.13.d": { difficulty: 25, studyTime: 15, examFreq: 50, why: "Know the MAC address table structure: MAC, VLAN, type (dynamic/static), port.", ciscoIntent: "Interpret MAC address table entries", cheatSheet: [{ heading: "MAC Address Table", items: ["Also called CAM (Content Addressable Memory) table", "Entries: VLAN | MAC Address | Type (dynamic/static) | Port", "Dynamic = learned from incoming frames. Static = manually configured.", "<code>show mac address-table</code> — all entries", "<code>show mac address-table dynamic</code> — only learned entries", "<code>clear mac address-table dynamic</code> — flush all dynamic entries"]}], prereqs: [{ name: "MAC learning", obj: "1.13.a" }], resources: [
      {"type":"video","title":"How Switches Work","url":"https://www.youtube.com/watch?v=9eH16Fxeb9o","desc":"MAC table aging timer (default 300s)"},
      {"type":"article","title":"NetworkLessons — How Does a Switch Learn MAC Addresses?","url":"https://networklessons.com/cisco/ccna-200-301/how-does-a-switch-learn-mac-addresses","desc":"MAC learning, frame forwarding, flooding, and aging"},
      {"type":"article","title":"NetworkLessons — Collision and Broadcast Domains","url":"https://networklessons.com/cisco/ccna-200-301/collision-domains","desc":"How switches create separate collision domains per port"}
    ], labs: [], vocab: [{ term: "MAC table", q: "What fields does a MAC address table entry contain?", options: ["IP, mask, next hop", "VLAN, MAC address, type, port", "SSID, channel, power", "Route code, prefix, AD"], answer: 1, explain: "Each entry maps: VLAN + MAC address → port, with a type (dynamic or static)." }] },

  "1.13.e": { difficulty: 30, studyTime: 15, examFreq: 45, why: "Store-and-forward vs cut-through is a classic exam question. Know the trade-offs between error checking and latency.", ciscoIntent: "Compare store-and-forward and cut-through switching methods", cheatSheet: [{ heading: "Store-and-Forward vs Cut-Through", items: ["Store-and-forward: receives ENTIRE frame, checks CRC, then forwards — catches errors but adds latency", "Cut-through: reads destination MAC (first 6 bytes after preamble), starts forwarding immediately — lowest latency but no error checking", "Fragment-free: reads first 64 bytes (minimum frame size), then forwards — catches runts, compromise between the two", "Most modern Cisco switches use store-and-forward by default", "Cut-through is used in low-latency environments (data center, HFT)", "Store-and-forward is required for switches that need to check frame integrity"]}], prereqs: [{ name: "MAC learning", obj: "1.13.a" }, { name: "Frame errors", obj: "1.4.b" }], resources: [
      {"type":"video","title":"How Switches Work","url":"https://www.youtube.com/watch?v=9eH16Fxeb9o","desc":"Switch forwarding methods — store-and-forward vs cut-through"},
      {"type":"article","title":"NetworkLessons — How Does a Switch Learn MAC Addresses?","url":"https://networklessons.com/cisco/ccna-200-301/how-does-a-switch-learn-mac-addresses","desc":"MAC learning and switching methods explained"},
      {"type":"article","title":"NetworkLessons — Collision and Broadcast Domains","url":"https://networklessons.com/cisco/ccna-200-301/collision-domains","desc":"How switches create separate collision domains per port"}
    ], labs: [], vocab: [{ term: "Store-and-forward", q: "What does a store-and-forward switch do before forwarding a frame?", options: ["Reads only the destination MAC", "Receives the entire frame and checks the CRC", "Reads the first 64 bytes only", "Forwards immediately without any checks"], answer: 1, explain: "Store-and-forward waits for the entire frame, runs a CRC check, and only forwards if the frame is error-free. This adds latency but catches corrupt frames." }, { term: "Cut-through", q: "When does a cut-through switch begin forwarding?", options: ["After receiving the entire frame", "After reading the destination MAC address", "After checking the CRC", "After 64 bytes"], answer: 1, explain: "Cut-through reads just enough of the frame to determine the destination MAC, then begins forwarding immediately — lowest latency but no error detection." }] },
  ...
  "2.1.b": { difficulty: 30, studyTime: 15, examFreq: 55, why: "Default VLAN is VLAN 1. All ports start here. Best practice: move traffic off VLAN 1.", ciscoIntent: "Explain the default VLAN and its security implications", cheatSheet: [{ heading: "Default VLAN", items: ["VLAN 1 — all ports belong to it by default", "Cannot be deleted or renamed", "Control protocols (CDP, VTP, STP BPDUs) use VLAN 1", "Security best practice: move all user traffic to other VLANs", "Default native VLAN on trunks = VLAN 1 (change it)"]}], prereqs: [], resources: [
      {"type":"video","title":"VLANs Explained","url":"https://www.youtube.com/watch?v=jC6MJTh9fRE","desc":"Default VLAN 1 — all ports start here, cannot be deleted"},
      {"type":"article","title":"NetworkLessons — Introduction to VLANs","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-vlans","desc":"VLAN concepts, access ports, and why VLANs matter"},
      {"type":"article","title":"NetworkLessons — VLAN Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-vlans-on-cisco-catalyst-switch","desc":"Step-by-step VLAN config with Cisco IOS commands"},
      {"type":"article","title":"NetworkLessons — Inter-VLAN Routing","url":"https://networklessons.com/cisco/ccna-200-301/intervlan-routing","desc":"Router-on-a-stick and L3 switch SVI methods"}
    ], labs: [], vocab: [{ term: "Default VLAN", q: "What is the default VLAN on Cisco switches?", options: ["VLAN 0", "VLAN 1", "VLAN 10", "VLAN 1002"], answer: 1, explain: "VLAN 1 is the default. Cannot be deleted. Best practice: move user traffic off VLAN 1." }] },
  ...
  "2.2.b": { difficulty: 40, studyTime: 25, examFreq: 65, why: "802.1Q is the only trunking encapsulation on the exam. Know where the tag goes and what it contains.", ciscoIntent: "Describe 802.1Q frame tagging", cheatSheet: [{ heading: "802.1Q", items: ["4-byte tag inserted after source MAC, before EtherType", "Contains: TPID (0x8100), Priority (3 bits/CoS), DEI (1 bit), VLAN ID (12 bits)", "12-bit VLAN ID → supports VLANs 1-4094", "ISL is Cisco-proprietary and deprecated — not on exam"]}], prereqs: [{ name: "Ethernet frame", obj: "1.13" }], resources: [
      {"type":"video","title":"Trunking Deep Dive","url":"https://www.youtube.com/watch?v=ISMaSyvG74w","desc":"802.1Q — 4-byte VLAN tag insertion into Ethernet frame"},
      {"type":"article","title":"NetworkLessons — 802.1Q Trunking","url":"https://networklessons.com/cisco/ccna-200-301/802-1q-encapsulation-explained","desc":"4-byte VLAN tag, trunk operation, and configuration"},
      {"type":"article","title":"NetworkLessons — Trunk Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-trunk-on-cisco-catalyst-switch","desc":"Step-by-step trunk setup on Cisco switches"},
      {"type":"article","title":"NetworkLessons — Native VLAN","url":"https://networklessons.com/cisco/ccna-200-301/802-1q-native-vlan-cisco-ios-switch","desc":"Native VLAN behavior, security risks, best practices"}
    ], labs: [], vocab: [{ term: "802.1Q", q: "Where is the 802.1Q tag inserted?", options: ["Before preamble", "After source MAC", "After IP header", "End of frame"], answer: 1, explain: "The 4-byte 802.1Q tag is inserted between source MAC and EtherType. It contains the VLAN ID (12 bits)." }] },
  ...
  "2.5.b": { difficulty: 55, studyTime: 30, examFreq: 60, why: "Rapid PVST+ port states: Discarding, Learning, Forwarding.", ciscoIntent: "Identify STP port states and roles", cheatSheet: [{ heading: "Port States & Roles", items: ["Discarding — not forwarding, not learning MACs (blocks loops)", "Learning — learning MACs but not yet forwarding data", "Forwarding — fully operational, learning and forwarding", "Rapid PVST+ converges faster than legacy STP (802.1D)", "Roles: Root, Designated, Alternate, Backup"]}], prereqs: [{ name: "Root election", obj: "2.5.a" }], resources: [
      {"type":"video","title":"STP Deep Dive","url":"https://www.youtube.com/watch?v=japdEY1UKe4","desc":"Port states — discarding, learning, forwarding"},
      {"type":"article","title":"NetworkLessons — Introduction to Spanning Tree","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-spanning-tree","desc":"Root bridge election, port roles, port states, STP operation"},
      {"type":"article","title":"NetworkLessons — Rapid Spanning Tree","url":"https://networklessons.com/cisco/ccna-200-301/rapid-spanning-tree-rstp","desc":"RSTP improvements over classic STP — faster convergence"},
      {"type":"article","title":"NetworkLessons — STP Cost Calculation","url":"https://networklessons.com/cisco/ccna-200-301/spanning-tree-cost-calculation","desc":"How path cost determines root port and best path"}
    ], labs: [], vocab: [{ term: "Port states", q: "In Rapid PVST+, what are the three port states?", options: ["Blocking, Listening, Forwarding", "Discarding, Learning, Forwarding", "Active, Standby, Down", "Open, Half-open, Closed"], answer: 1, explain: "Rapid PVST+ simplified to three states: Discarding, Learning, Forwarding." }] },
  ...
  "2.5.d": { difficulty: 50, studyTime: 30, examFreq: 55, why: "STP protection mechanisms prevent unauthorized topology changes. BPDU Guard is most commonly tested.", ciscoIntent: "Describe STP protection features", cheatSheet: [{ heading: "STP Protection", items: ["BPDU Guard — shuts port (err-disabled) if BPDU received. Use on PortFast ports.", "BPDU Filter — suppresses BPDUs on a port. Use carefully — can cause loops.", "Root Guard — prevents port from becoming root port. Protects root bridge placement.", "Loop Guard — prevents blocked port from forwarding if BPDUs stop arriving."]}], prereqs: [{ name: "PortFast", obj: "2.5.c" }], resources: [
      {"type":"video","title":"PortFast and BPDU Guard","url":"https://www.youtube.com/watch?v=1iciXlaIH2I","desc":"Root guard and BPDU guard — preventing rogue switches"},
      {"type":"article","title":"NetworkLessons — Introduction to Spanning Tree","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-spanning-tree","desc":"Root bridge election, port roles, port states, STP operation"},
      {"type":"article","title":"NetworkLessons — Rapid Spanning Tree","url":"https://networklessons.com/cisco/ccna-200-301/rapid-spanning-tree-rstp","desc":"RSTP improvements over classic STP — faster convergence"},
      {"type":"article","title":"NetworkLessons — STP Cost Calculation","url":"https://networklessons.com/cisco/ccna-200-301/spanning-tree-cost-calculation","desc":"How path cost determines root port and best path"}
    ], labs: [{ name: "BPDU Guard test", desc: "Enable BPDU Guard, connect a rogue switch, watch port shut down" }], vocab: [{ term: "BPDU Guard", q: "What happens when a BPDU Guard port receives a BPDU?", options: ["Logs and continues", "Goes err-disabled (shut down)", "Becomes root port", "Starts STP negotiation"], answer: 1, explain: "BPDU Guard immediately err-disables the port. Must be manually re-enabled." }] },
  ...
  "2.7": { difficulty: 30, studyTime: 20, examFreq: 35, why: "Know how APs, WLCs, and switches physically connect (PoE, trunks, LAG).", ciscoIntent: "Describe WLAN physical connectivity", cheatSheet: [{ heading: "WLAN Physical Connections", items: ["AP → switch via PoE port (access or trunk)", "WLC → distribution/core via trunk (carries all WLAN VLANs)", "LAG on WLC — bundles ports for redundancy/bandwidth", "Management VLAN for WLC management interface"]}], prereqs: [{ name: "Trunking", obj: "2.2" }, { name: "PoE", obj: "1.1.h" }], resources: [
      {"type":"article","title":"NetworkLessons — Wireless LAN Introduction","url":"https://networklessons.com/cisco/ccna-200-301/introduction-wireless-lan","desc":"WLAN components, AP-to-switch connections, PoE, LAG"}
    ], labs: [{ name: "Draw WLAN topology", desc: "AP → switch → WLC → core with port types labeled" }], vocab: [{ term: "WLC LAG", q: "Why configure LAG on a WLC?", options: ["Create VLANs", "Bundle ports for bandwidth and redundancy", "Encrypt management", "Assign IPs to APs"], answer: 1, explain: "LAG bundles WLC uplinks into one logical connection for bandwidth + redundancy." }] },
  ...
  "2.9": { difficulty: 30, studyTime: 20, examFreq: 35, why: "WLC GUI configuration — Cisco may show a screenshot.", ciscoIntent: "Interpret WLC GUI for WLAN setup", cheatSheet: [{ heading: "WLAN GUI", items: ["Create WLAN: Profile Name + SSID + WLAN ID", "Security: L2 security (WPA2), auth (PSK or 802.1X)", "QoS: Platinum (voice), Gold (video), Silver (best effort), Bronze (background)", "Interface mapping: assign WLAN to a VLAN interface"]}], prereqs: [{ name: "Wireless principles", obj: "1.11" }], resources: [
      {"type":"article","title":"NetworkLessons — WLC Basic Configuration","url":"https://networklessons.com/cisco/ccna-200-301/cisco-wireless-lan-controller-wlc-basic-configuration","desc":"WLC GUI walkthrough — WLAN creation, security, interface mapping"},
      {"type":"article","title":"NetworkLessons — WLC WPA2 PSK","url":"https://networklessons.com/cisco/ccna-200-301/cisco-wlc-wpa2-psk-authentication","desc":"Configure WPA2-PSK on a WLC via the GUI"}
    ], labs: [], vocab: [{ term: "WLAN Profile", q: "What two identifiers does a WLAN have?", options: ["SSID and MAC", "Profile Name and SSID", "IP and port", "Channel and power"], answer: 1, explain: "Profile Name is the internal WLC ID. SSID is what clients see. Can differ." }] },
  ...
  "3.1.b": { difficulty: 40, studyTime: 20, examFreq: 75, why: "The prefix is the network destination.", ciscoIntent: "Identify the network prefix in a route entry", cheatSheet: [{ heading: "Prefix", items: ["The network address in the routing table entry", "Example: 10.1.1.0/24 — the prefix is 10.1.1.0", "More specific prefix (longer mask) = more precise route"]}], prereqs: [{ name: "Subnetting", obj: "1.6" }], resources: [
      {"type":"video","title":"Reading the Routing Table","url":"https://www.youtube.com/watch?v=jLln6BDMEBk","desc":"Prefix — network address portion of a route entry"},
      {"type":"article","title":"NetworkLessons — IP Routing Explained","url":"https://networklessons.com/cisco/ccna-200-301/ip-routing-explained","desc":"Routing table structure, connected/static/dynamic routes, AD, metric"},
      {"type":"article","title":"NetworkLessons — Administrative Distance","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-administrative-distance","desc":"AD values for every routing source — the tiebreaker table"}
    ], labs: [], vocab: [{ term: "Prefix", q: "In route '10.1.1.0/24 via 192.168.1.1', what is the prefix?", options: ["192.168.1.1", "10.1.1.0/24", "/24", "via"], answer: 1, explain: "The prefix is the destination network — 10.1.1.0/24." }] },
  "3.1.c": { difficulty: 35, studyTime: 15, examFreq: 70, why: "Network mask determines how specific the route is.", ciscoIntent: "Interpret the mask in a routing table entry", cheatSheet: [{ heading: "Network Mask", items: ["Defines how many bits are the network portion", "/24 = 255.255.255.0, /16 = 255.255.0.0, etc.", "Longer mask = more specific route = preferred in longest prefix match"]}], prereqs: [{ name: "Subnetting", obj: "1.6" }], resources: [
      {"type":"video","title":"Reading the Routing Table","url":"https://www.youtube.com/watch?v=jLln6BDMEBk","desc":"Network mask — subnet mask or prefix length in the route"},
      {"type":"article","title":"NetworkLessons — IP Routing Explained","url":"https://networklessons.com/cisco/ccna-200-301/ip-routing-explained","desc":"Routing table structure, connected/static/dynamic routes, AD, metric"},
      {"type":"article","title":"NetworkLessons — Administrative Distance","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-administrative-distance","desc":"AD values for every routing source — the tiebreaker table"}
    ], labs: [], vocab: [{ term: "Mask", q: "Which route is more specific: /24 or /28?", options: ["/24", "/28", "They're equal", "Depends on AD"], answer: 1, explain: "/28 has more network bits = more specific. It wins in longest prefix match." }] },
  "3.1.d": { difficulty: 40, studyTime: 20, examFreq: 80, why: "Next hop tells the router where to send the packet.", ciscoIntent: "Identify next hop in a route", cheatSheet: [{ heading: "Next Hop", items: ["The IP address of the next router in the path", "Or an exit interface (for directly connected or point-to-point)", "Example: 'via 10.2.2.1' means forward to 10.2.2.1"]}], prereqs: [{ name: "Routing basics", obj: "1.1.a" }], resources: [
      {"type":"video","title":"Reading the Routing Table","url":"https://www.youtube.com/watch?v=jLln6BDMEBk","desc":"Next hop — IP of the next router in the forwarding path"},
      {"type":"article","title":"NetworkLessons — IP Routing Explained","url":"https://networklessons.com/cisco/ccna-200-301/ip-routing-explained","desc":"Routing table structure, connected/static/dynamic routes, AD, metric"},
      {"type":"article","title":"NetworkLessons — Administrative Distance","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-administrative-distance","desc":"AD values for every routing source — the tiebreaker table"}
    ], labs: [], vocab: [{ term: "Next hop", q: "What is the next hop in a routing table?", options: ["Final destination", "IP of the next router toward the destination", "Source IP", "Broadcast address"], answer: 1, explain: "Next hop is the IP of the next router in the forwarding path." }] },
  "3.1.e": { difficulty: 50, studyTime: 30, examFreq: 85, why: "AD determines which routing source is trusted. Lower = more trusted. Critical for route selection.", ciscoIntent: "Use AD to determine the preferred route source", cheatSheet: [{ heading: "Administrative Distance", items: ["Trustworthiness of a route source. Lower = preferred.", "Connected = 0, Static = 1, EIGRP = 90, OSPF = 110, RIP = 120, Unknown = 255", "If same destination from multiple sources → lowest AD wins", "Floating static = static route with artificially high AD (e.g., 200) as backup"]}], prereqs: [], resources: [
      {"type":"video","title":"Reading the Routing Table","url":"https://www.youtube.com/watch?v=jLln6BDMEBk","desc":"Administrative distance — lower = more trusted route source"},
      {"type":"article","title":"NetworkLessons — IP Routing Explained","url":"https://networklessons.com/cisco/ccna-200-301/ip-routing-explained","desc":"Routing table structure, connected/static/dynamic routes, AD, metric"},
      {"type":"article","title":"NetworkLessons — Administrative Distance","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-administrative-distance","desc":"AD values for every routing source — the tiebreaker table"}
    ], labs: [], vocab: [{ term: "AD", q: "OSPF (110) and static (1) routes to same destination — which wins?", options: ["OSPF (higher = more trusted)", "Static (lower = more trusted)", "Both used", "Most recent"], answer: 1, explain: "Lower AD wins. Static (1) beats OSPF (110)." }] },
  "3.1.f": { difficulty: 40, studyTime: 20, examFreq: 70, why: "Metric is the tiebreaker within a single routing protocol.", ciscoIntent: "Explain how metric selects the best route within a protocol", cheatSheet: [{ heading: "Metric", items: ["Cost/distance value WITHIN a routing protocol. Lower = preferred.", "OSPF metric = cost (based on bandwidth). 100Mbps reference / link BW.", "RIP metric = hop count (max 15, 16 = unreachable)", "EIGRP metric = composite (bandwidth + delay by default)"]}], prereqs: [{ name: "AD", obj: "3.1.e" }], resources: [
      {"type":"video","title":"Reading the Routing Table","url":"https://www.youtube.com/watch?v=jLln6BDMEBk","desc":"Metric — cost within a routing protocol (lower = preferred)"},
      {"type":"article","title":"NetworkLessons — IP Routing Explained","url":"https://networklessons.com/cisco/ccna-200-301/ip-routing-explained","desc":"Routing table structure, connected/static/dynamic routes, AD, metric"},
      {"type":"article","title":"NetworkLessons — Administrative Distance","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-administrative-distance","desc":"AD values for every routing source — the tiebreaker table"}
    ], labs: [], vocab: [{ term: "Metric", q: "OSPF metric is based on?", options: ["Hop count", "Cost (bandwidth-based)", "Delay only", "MTU"], answer: 1, explain: "OSPF cost = reference bandwidth / interface bandwidth. Default reference = 100 Mbps." }] },
  "3.1.g": { difficulty: 35, studyTime: 15, examFreq: 65, why: "Gateway of last resort is the default route — the catch-all.", ciscoIntent: "Identify the gateway of last resort in show ip route", cheatSheet: [{ heading: "Gateway of Last Resort", items: ["The default route: 0.0.0.0/0", "Used when no more specific route matches", "Shown at top of 'show ip route' output", "If not set: 'Gateway of last resort is not set' — packets to unknown destinations are dropped"]}], prereqs: [{ name: "Static routing", obj: "3.3" }], resources: [
      {"type":"video","title":"Reading the Routing Table","url":"https://www.youtube.com/watch?v=jLln6BDMEBk","desc":"Gateway of last resort — the default route (0.0.0.0/0)"},
      {"type":"article","title":"NetworkLessons — IP Routing Explained","url":"https://networklessons.com/cisco/ccna-200-301/ip-routing-explained","desc":"Routing table structure, connected/static/dynamic routes, AD, metric"},
      {"type":"article","title":"NetworkLessons — Administrative Distance","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-administrative-distance","desc":"AD values for every routing source — the tiebreaker table"}
    ], labs: [], vocab: [{ term: "Default route", q: "When is the gateway of last resort used?", options: ["Always", "Only when no more specific route matches", "Only for multicast", "Only during STP"], answer: 1, explain: "0.0.0.0/0 is the catch-all — used only when no other route matches." }] },
  ...
  "3.2.b": { difficulty: 40, studyTime: 20, examFreq: 70, why: "AD breaks ties between different routing sources for the same prefix.", ciscoIntent: "Apply AD when multiple sources know the same prefix", cheatSheet: [{ heading: "AD in Forwarding", items: ["Same prefix from OSPF (110) and static (1) → static wins", "AD only compares routes to the SAME destination prefix", "AD is NOT compared across different prefixes — longest match first"]}], prereqs: [{ name: "AD", obj: "3.1.e" }], resources: [
      {"type":"video","title":"Longest Prefix Match Explained","url":"https://www.youtube.com/watch?v=RXOjclhJCPQ","desc":"AD as tiebreaker between different routing sources"},
      {"type":"article","title":"NetworkLessons — Longest Prefix Match","url":"https://networklessons.com/cisco/ccna-200-301/longest-prefix-match-routing","desc":"How routers pick the most specific route — /30 beats /24 beats /0"},
      {"type":"article","title":"NetworkLessons — Administrative Distance","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-administrative-distance","desc":"Complete AD table and how it fits into the decision order"}
    ], labs: [], vocab: [{ term: "AD tiebreaker", q: "When does AD matter?", options: ["Always", "When multiple sources know the same prefix", "Only for OSPF", "Never"], answer: 1, explain: "AD only breaks ties when the same prefix is learned from multiple routing sources." }] },
  "3.2.c": { difficulty: 40, studyTime: 20, examFreq: 65, why: "Metric breaks ties within the SAME routing protocol for the same prefix.", ciscoIntent: "Apply metric when same protocol has multiple paths", cheatSheet: [{ heading: "Metric in Forwarding", items: ["Same prefix, same protocol, different paths → lowest metric wins", "OSPF: lowest cost. RIP: fewest hops. EIGRP: composite calculation.", "Equal-cost paths may load-balance (ECMP)"]}], prereqs: [{ name: "Metric", obj: "3.1.f" }], resources: [
      {"type":"video","title":"Longest Prefix Match Explained","url":"https://www.youtube.com/watch?v=RXOjclhJCPQ","desc":"AD values — Connected 0, Static 1, OSPF 110, RIP 120"},
      {"type":"article","title":"NetworkLessons — Longest Prefix Match","url":"https://networklessons.com/cisco/ccna-200-301/longest-prefix-match-routing","desc":"How routers pick the most specific route — /30 beats /24 beats /0"},
      {"type":"article","title":"NetworkLessons — Administrative Distance","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-administrative-distance","desc":"Complete AD table and how it fits into the decision order"}
    ], labs: [], vocab: [{ term: "ECMP", q: "What happens with equal-cost routes?", options: ["One is dropped", "Load balancing across both paths", "The oldest wins", "Error"], answer: 1, explain: "Equal-Cost Multi-Path (ECMP) distributes traffic across paths with identical cost." }] },
  ...
  "3.3.b": { difficulty: 30, studyTime: 15, examFreq: 60, why: "Network routes direct traffic to a specific subnet.", ciscoIntent: "Configure a network static route", cheatSheet: [{ heading: "Network Route", items: ["<code>ip route 10.1.0.0 255.255.0.0 192.168.1.1</code>", "Routes traffic for the 10.1.0.0/16 network via next hop 192.168.1.1"]}], prereqs: [{ name: "Subnetting", obj: "1.6" }], resources: [
      {"type":"video","title":"Static Routing Explained","url":"https://www.youtube.com/watch?v=gBL6STojGhk","desc":"Network route — ip route [network] [mask] [next-hop]"},
      {"type":"article","title":"NetworkLessons — Static Route Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-static-route-on-cisco-ios-router","desc":"Next-hop vs exit-interface, default route, IPv4 and IPv6 static routes"},
      {"type":"article","title":"NetworkLessons — Floating Static Route","url":"https://networklessons.com/cisco/ccna-200-301/floating-static-route","desc":"Backup routes with higher AD for failover scenarios"}
    ], labs: [], vocab: [{ term: "Network route", q: "What does a network static route specify?", options: ["One host", "A subnet destination and next hop", "All traffic", "Only DNS traffic"], answer: 1, explain: "A network route sends traffic for a specific subnet to a specified next hop." }] },
  "3.3.c": { difficulty: 25, studyTime: 10, examFreq: 40, why: "Host routes are /32 — point to a single IP address.", ciscoIntent: "Configure a host static route", cheatSheet: [{ heading: "Host Route", items: ["<code>ip route 10.1.1.100 255.255.255.255 192.168.1.1</code>", "/32 mask = single host. Most specific possible route."]}], prereqs: [{ name: "Subnetting", obj: "1.6" }], resources: [
      {"type":"video","title":"Static Routing Explained","url":"https://www.youtube.com/watch?v=gBL6STojGhk","desc":"Host route — /32 prefix for a single destination"},
      {"type":"article","title":"NetworkLessons — Static Route Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-static-route-on-cisco-ios-router","desc":"Next-hop vs exit-interface, default route, IPv4 and IPv6 static routes"},
      {"type":"article","title":"NetworkLessons — Floating Static Route","url":"https://networklessons.com/cisco/ccna-200-301/floating-static-route","desc":"Backup routes with higher AD for failover scenarios"}
    ], labs: [], vocab: [{ term: "Host route", q: "What mask does a host route use?", options: ["/24", "/30", "/32", "/0"], answer: 2, explain: "/32 = all 32 bits are network, leaving zero host bits. Matches exactly one IP." }] },
  "3.3.d": { difficulty: 40, studyTime: 20, examFreq: 50, why: "Floating statics are backup routes with artificially high AD.", ciscoIntent: "Configure a floating static route as backup", cheatSheet: [{ heading: "Floating Static", items: ["Static route with higher AD → only installs when primary route fails", "<code>ip route 10.0.0.0 255.0.0.0 10.2.2.1 200</code> (AD 200)", "Normal static AD = 1. Setting AD 200 means it loses to OSPF (110) or EIGRP (90).", "When the primary route disappears, floating static activates."]}], prereqs: [{ name: "AD", obj: "3.1.e" }], resources: [
      {"type":"video","title":"Static Routing Explained","url":"https://www.youtube.com/watch?v=gBL6STojGhk","desc":"Floating static — backup route with higher AD"},
      {"type":"article","title":"NetworkLessons — Static Route Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-static-route-on-cisco-ios-router","desc":"Next-hop vs exit-interface, default route, IPv4 and IPv6 static routes"},
      {"type":"article","title":"NetworkLessons — Floating Static Route","url":"https://networklessons.com/cisco/ccna-200-301/floating-static-route","desc":"Backup routes with higher AD for failover scenarios"}
    ], labs: [], vocab: [{ term: "Floating static", q: "What is a floating static route?", options: ["A route that changes dynamically", "A static route with high AD — only activates when primary fails", "A default route", "An OSPF route"], answer: 1, explain: "High AD keeps it hidden until the primary route (with lower AD) disappears." }] },
  ...
  "3.4.b": { difficulty: 55, studyTime: 30, examFreq: 65, why: "Point-to-point OSPF networks don't elect DR/BDR.", ciscoIntent: "Describe OSPF on point-to-point networks", cheatSheet: [{ heading: "Point-to-Point", items: ["No DR/BDR election — only two routers on the link", "Hello/Dead: 10/40 seconds", "Full adjacency forms directly", "Common on serial links and point-to-point Ethernet subinterfaces", "<code>ip ospf network point-to-point</code>"]}], prereqs: [{ name: "OSPF adjacencies", obj: "3.4.a" }], resources: [
      {"type":"video","title":"OSPF Explained","url":"https://www.youtube.com/watch?v=kfvJ8QVJscc","desc":"Point-to-point — no DR/BDR, two routers only"},
      {"type":"article","title":"NetworkLessons — OSPF Explained","url":"https://networklessons.com/cisco/ccna-200-301/open-shortest-path-first-ospf-explained","desc":"OSPF overview, areas, LSAs, adjacency formation"},
      {"type":"article","title":"NetworkLessons — OSPF Configuration","url":"https://networklessons.com/cisco/ccna-200-301/basic-ospf-configuration","desc":"network command, interface method, router-id, wildcard masks"},
      {"type":"article","title":"NetworkLessons — OSPF DR/BDR Election","url":"https://networklessons.com/cisco/ccna-200-301/ospf-drbdr-election-explained","desc":"How priority and router-id determine DR/BDR roles"},
      {"type":"article","title":"NetworkLessons — OSPF Neighbor Discovery","url":"https://networklessons.com/cisco/ccna-200-301/ospf-packets-and-neighbor-discovery","desc":"Hello packets, Dead intervals, adjacency requirements"},
      {"type":"article","title":"NetworkLessons — Troubleshooting OSPF","url":"https://networklessons.com/cisco/ccna-200-301/troubleshooting-ospf-neighbor-adjacency","desc":"Common OSPF issues — timer mismatch, area mismatch, authentication"}
    ], labs: [], vocab: [{ term: "Point-to-point", q: "Is DR/BDR elected on point-to-point OSPF?", options: ["Yes, always", "No — only two routers, no need", "Only if manually configured", "Depends on area type"], answer: 1, explain: "Point-to-point has only two routers — DR/BDR election is unnecessary." }] },
  ...
  "1.7.a": { difficulty: 15, studyTime: 10, examFreq: 60, why: "The Class A private range is one of three you must memorize. These are on every CCNA exam.", ciscoIntent: "Identify the Class A private IPv4 range", cheatSheet: [{ heading: "Class A Private", items: ["Range: <code>10.0.0.0 - 10.255.255.255</code>", "CIDR: <code>10.0.0.0/8</code>", "Subnet mask: 255.0.0.0", "Over 16 million addresses", "Most commonly used in enterprise networks due to huge address space", "RFC 1918 defined all three private ranges"]}], prereqs: [{ name: "Classful addressing", obj: "1.6.b" }], resources: [
      {"type":"video","title":"Private IP Addresses Explained","url":"https://www.youtube.com/watch?v=po8ZFG0Xc4Q","desc":"Class A private — 10.0.0.0/8"},
      {"type":"article","title":"NetworkLessons — Internet Protocol","url":"https://networklessons.com/cisco/ccna-200-301/internet-protocol","desc":"IPv4 addressing including private ranges (RFC 1918) and special addresses"}
    ], labs: [], vocab: [{ term: "10.x.x.x", q: "What is the CIDR notation for the Class A private range?", options: ["10.0.0.0/8", "10.0.0.0/16", "10.0.0.0/24", "10.0.0.0/12"], answer: 0, explain: "The Class A private range is 10.0.0.0/8 -- the entire first octet (10) is the network, giving 16M+ addresses." }] },
  "1.7.b": { difficulty: 20, studyTime: 10, examFreq: 60, why: "The Class B private range has a tricky upper boundary (172.31.255.255). Cisco loves testing whether you know the exact limits.", ciscoIntent: "Identify the Class B private IPv4 range and its boundaries", cheatSheet: [{ heading: "Class B Private", items: ["Range: <code>172.16.0.0 - 172.31.255.255</code>", "CIDR: <code>172.16.0.0/12</code>", "NOT /16 -- the /12 means the range extends from 172.16.x.x to 172.31.x.x", "Over 1 million addresses", "Trap: 172.32.0.0 is NOT private -- only 172.16 through 172.31", "Second octet range: 16 to 31 (16 Class B networks)"]}], prereqs: [{ name: "Classful addressing", obj: "1.6.b" }], resources: [
      {"type":"video","title":"Private IP Addresses Explained","url":"https://www.youtube.com/watch?v=po8ZFG0Xc4Q","desc":"Class B private — 172.16.0.0/12"},
      {"type":"article","title":"NetworkLessons — Internet Protocol","url":"https://networklessons.com/cisco/ccna-200-301/internet-protocol","desc":"IPv4 addressing including private ranges (RFC 1918) and special addresses"}
    ], labs: [], vocab: [{ term: "172.16.0.0/12", q: "Is 172.32.1.1 a private address?", options: ["Yes, it's in the 172.16.0.0/12 range", "No, 172.16.0.0/12 only covers 172.16.0.0 through 172.31.255.255", "Yes, all 172.x.x.x addresses are private", "No, 172 addresses are never private"], answer: 1, explain: "The /12 mask means only 172.16.0.0 through 172.31.255.255 are private. 172.32.x.x is public." }] },
  "1.7.c": { difficulty: 15, studyTime: 10, examFreq: 55, why: "The Class C private range is the most recognized (home networks). Know the exact CIDR.", ciscoIntent: "Identify the Class C private IPv4 range", cheatSheet: [{ heading: "Class C Private", items: ["Range: <code>192.168.0.0 - 192.168.255.255</code>", "CIDR: <code>192.168.0.0/16</code>", "65,534 usable addresses", "Most common in home/SOHO networks", "Default on most consumer routers (192.168.1.0/24, 192.168.0.0/24)", "Entire 192.168.x.x space is private"]}], prereqs: [{ name: "Classful addressing", obj: "1.6.b" }], resources: [
      {"type":"video","title":"Private IP Addresses Explained","url":"https://www.youtube.com/watch?v=po8ZFG0Xc4Q","desc":"Class C private — 192.168.0.0/16"},
      {"type":"article","title":"NetworkLessons — Internet Protocol","url":"https://networklessons.com/cisco/ccna-200-301/internet-protocol","desc":"IPv4 addressing including private ranges (RFC 1918) and special addresses"}
    ], labs: [], vocab: [{ term: "192.168.x.x", q: "What is the CIDR for the entire Class C private address space?", options: ["192.168.0.0/8", "192.168.0.0/16", "192.168.0.0/24", "192.168.1.0/24"], answer: 1, explain: "192.168.0.0/16 covers all addresses from 192.168.0.0 to 192.168.255.255." }] },
  ...
  "1.12.g": { difficulty: 25, studyTime: 15, examFreq: 30, why: "NFV virtualizes network functions (firewall, load balancer, WAN optimizer) as software on standard hardware instead of dedicated appliances.", ciscoIntent: "Describe NFV and how it differs from traditional hardware-based network functions", cheatSheet: [{ heading: "NFV (Network Functions Virtualization)", items: ["Replaces dedicated hardware appliances with software running on standard servers", "VNFs (Virtual Network Functions): virtual firewalls, load balancers, WAN optimizers, IDS/IPS", "Benefits: lower cost, faster deployment, easier scaling, vendor flexibility", "NFVI (NFV Infrastructure): compute, storage, networking hardware hosting VNFs", "NFV Orchestrator (NFVO): manages lifecycle of VNFs (deploy, scale, terminate)", "Related to but distinct from SDN — SDN separates control/data plane; NFV virtualizes functions"]}], prereqs: [{ name: "Virtualization", obj: "1.12.a" }, { name: "SDN", obj: "6.2" }], resources: [
      {"type":"article","title":"NetworkLessons — Virtualization, Containers, and VMs","url":"https://networklessons.com/cisco/ccna-200-301/compute-virtualization-containers-and-virtual-machines","desc":"Virtualization concepts including NFV and virtual network functions"},
      {"type":"video","title":"VMs vs Containers Explained","url":"https://www.youtube.com/watch?v=cjXI-yxqGTI","desc":"How virtualization applies to network functions"}
    ], labs: [], vocab: [{ term: "VNF", q: "What is a Virtual Network Function?", options: ["A physical firewall appliance", "A network function implemented as software on standard hardware", "A VLAN configuration template", "A type of VRF"], answer: 1, explain: "VNFs are software implementations of network functions (firewalls, load balancers, etc.) that traditionally required dedicated hardware appliances." }] },

  // ── Domain 2 NEW entries ──

  // ── 2.3 CDP and LLDP ────────────────────────────────────────────────
  "2.3.a": { difficulty: 20, studyTime: 10, examFreq: 45, why: "CDP is Cisco's built-in discovery tool and it's ON by default. Know what it reveals and the security risk.", ciscoIntent: "Describe CDP as a Cisco proprietary Layer 2 discovery protocol", cheatSheet: [{ heading: "CDP Overview", items: ["Cisco Discovery Protocol -- Cisco proprietary, Layer 2", "Enabled by default on all Cisco devices", "Sends advertisements every 60 seconds (default), holdtime 180 seconds", "Reveals: hostname, IP address, platform/model, port ID, IOS version, VTP domain", "Works between directly connected Cisco devices only (not through routers)", "Security risk: exposes device info to anyone on the link"]}], prereqs: [{ name: "Switching concepts", obj: "1.13" }], resources: [
      {"type":"video","title":"CDP and LLDP Explained","url":"https://www.youtube.com/watch?v=GKpZ5w8Vihs","desc":"CDP — Cisco proprietary, Layer 2, enabled by default"},
      {"type":"article","title":"NetworkLessons — CDP","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-cdp-cisco-discovery-protocol","desc":"Cisco Discovery Protocol commands and output"},
      {"type":"article","title":"NetworkLessons — LLDP","url":"https://networklessons.com/cisco/ccna-200-301/link-layer-discovery-protocol-lldp","desc":"IEEE 802.1AB open-standard neighbor discovery"}
    ], labs: [], vocab: [{ term: "CDP", q: "How often does CDP send advertisements by default?", options: ["30 seconds", "60 seconds", "90 seconds", "120 seconds"], answer: 1, explain: "CDP sends updates every 60 seconds by default with a 180-second holdtime." }] },
  "2.3.b": { difficulty: 25, studyTime: 15, examFreq: 50, why: "These CDP show commands are used to discover and document network topology without a diagram.", ciscoIntent: "Use CDP show commands to discover neighbors", cheatSheet: [{ heading: "CDP Show Commands", items: ["<code>show cdp neighbors</code> -- summary: device ID, local/remote port, platform, capability", "<code>show cdp neighbors detail</code> -- adds: IP address, IOS version, VTP domain, native VLAN", "<code>show cdp entry *</code> -- same as neighbors detail (all entries)", "<code>show cdp entry [device-name]</code> -- detail for one specific neighbor", "<code>show cdp</code> -- global CDP status (timer, holdtime, version)", "<code>show cdp interface</code> -- which interfaces have CDP enabled"]}], prereqs: [{ name: "CDP overview", obj: "2.3.a" }], resources: [
      {"type":"video","title":"CDP and LLDP Explained","url":"https://www.youtube.com/watch?v=GKpZ5w8Vihs","desc":"CDP commands — show cdp neighbors, show cdp neighbors detail"},
      {"type":"article","title":"NetworkLessons — CDP","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-cdp-cisco-discovery-protocol","desc":"Cisco Discovery Protocol commands and output"},
      {"type":"article","title":"NetworkLessons — LLDP","url":"https://networklessons.com/cisco/ccna-200-301/link-layer-discovery-protocol-lldp","desc":"IEEE 802.1AB open-standard neighbor discovery"}
    ], labs: [{ name: "CDP topology discovery", desc: "Use show cdp neighbors to map a network topology without a diagram" }], vocab: [{ term: "show cdp neighbors", q: "What additional info does 'show cdp neighbors detail' provide over 'show cdp neighbors'?", options: ["Only port IDs", "IP address, IOS version, VTP domain, native VLAN", "Routing table", "Spanning tree info"], answer: 1, explain: "The detail version adds management IP, software version, VTP domain, and native VLAN to the basic neighbor table." }] },
  "2.3.c": { difficulty: 20, studyTime: 10, examFreq: 45, why: "Knowing how to enable and disable CDP globally and per-interface is a common simlet task.", ciscoIntent: "Enable and disable CDP at global and interface levels", cheatSheet: [{ heading: "CDP Enable/Disable", items: ["Global enable: <code>cdp run</code> (default -- already on)", "Global disable: <code>no cdp run</code> (disables on ALL interfaces)", "Per-interface enable: <code>cdp enable</code>", "Per-interface disable: <code>no cdp enable</code>", "Best practice: disable CDP on external-facing interfaces (to ISP, untrusted)", "Global must be on for per-interface to work"]}], prereqs: [{ name: "CDP commands", obj: "2.3.b" }], resources: [
      {"type":"video","title":"CDP and LLDP Explained","url":"https://www.youtube.com/watch?v=GKpZ5w8Vihs","desc":"CDP enable/disable — cdp run, cdp enable, no cdp run"},
      {"type":"article","title":"NetworkLessons — CDP","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-cdp-cisco-discovery-protocol","desc":"Cisco Discovery Protocol commands and output"},
      {"type":"article","title":"NetworkLessons — LLDP","url":"https://networklessons.com/cisco/ccna-200-301/link-layer-discovery-protocol-lldp","desc":"IEEE 802.1AB open-standard neighbor discovery"}
    ], labs: [], vocab: [{ term: "CDP disable", q: "How do you disable CDP on a single interface without affecting other interfaces?", options: ["no cdp run", "no cdp enable (on the interface)", "shutdown the interface", "no cdp advertise"], answer: 1, explain: "'no cdp enable' disables CDP on that specific interface. 'no cdp run' would disable it globally on all interfaces." }] },
  ...
  "3.2.d": {
    ...
    resources: [
      {"type":"video","title":"Longest Prefix Match Explained","url":"https://www.youtube.com/watch?v=RXOjclhJCPQ","desc":"Metric as tiebreaker within the same routing protocol"},
      {"type":"article","title":"NetworkLessons — Longest Prefix Match","url":"https://networklessons.com/cisco/ccna-200-301/longest-prefix-match-routing","desc":"How routers pick the most specific route — /30 beats /24 beats /0"},
      {"type":"article","title":"NetworkLessons — Administrative Distance","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-administrative-distance","desc":"Complete AD table and how it fits into the decision order"}
    ],
  ...
  "3.2.e": {
    ...
    resources: [
      {"type":"video","title":"Longest Prefix Match Explained","url":"https://www.youtube.com/watch?v=RXOjclhJCPQ","desc":"Decision order — 1st longest match, 2nd AD, 3rd metric"},
      {"type":"article","title":"NetworkLessons — Longest Prefix Match","url":"https://networklessons.com/cisco/ccna-200-301/longest-prefix-match-routing","desc":"How routers pick the most specific route — /30 beats /24 beats /0"},
      {"type":"article","title":"NetworkLessons — Administrative Distance","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-administrative-distance","desc":"Complete AD table and how it fits into the decision order"}
    ],
  ...
  "3.3.e": {
    ...
    resources: [
      {"type":"video","title":"Static Routing Explained","url":"https://www.youtube.com/watch?v=gBL6STojGhk","desc":"IPv6 static — ipv6 route [prefix/length] [next-hop]"},
      {"type":"article","title":"NetworkLessons — Static Route Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-static-route-on-cisco-ios-router","desc":"Next-hop vs exit-interface, default route, IPv4 and IPv6 static routes"},
      {"type":"article","title":"NetworkLessons — Floating Static Route","url":"https://networklessons.com/cisco/ccna-200-301/floating-static-route","desc":"Backup routes with higher AD for failover scenarios"}
    ],
  ...
  "3.3.f": {
    ...
    resources: [
      {"type":"video","title":"Static Routing Explained","url":"https://www.youtube.com/watch?v=gBL6STojGhk","desc":"Next-hop vs exit-interface — recursive vs direct lookup"},
      {"type":"article","title":"NetworkLessons — Static Route Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-static-route-on-cisco-ios-router","desc":"Next-hop vs exit-interface, default route, IPv4 and IPv6 static routes"},
      {"type":"article","title":"NetworkLessons — Floating Static Route","url":"https://networklessons.com/cisco/ccna-200-301/floating-static-route","desc":"Backup routes with higher AD for failover scenarios"}
    ],
  ...
  "3.3.g": {
    ...
    resources: [
      {"type":"video","title":"Static Routing Explained","url":"https://www.youtube.com/watch?v=gBL6STojGhk","desc":"Verify — show ip route static, show ipv6 route"},
      {"type":"article","title":"NetworkLessons — Static Route Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-static-route-on-cisco-ios-router","desc":"Next-hop vs exit-interface, default route, IPv4 and IPv6 static routes"},
      {"type":"article","title":"NetworkLessons — Floating Static Route","url":"https://networklessons.com/cisco/ccna-200-301/floating-static-route","desc":"Backup routes with higher AD for failover scenarios"}
    ],
  ...
  "3.4.e": {
    ...
    resources: [
      {"type":"video","title":"OSPF Explained","url":"https://www.youtube.com/watch?v=kfvJ8QVJscc","desc":"Config — router ospf, network command, interface method"},
      {"type":"article","title":"NetworkLessons — OSPF Explained","url":"https://networklessons.com/cisco/ccna-200-301/open-shortest-path-first-ospf-explained","desc":"OSPF overview, areas, LSAs, adjacency formation"},
      {"type":"article","title":"NetworkLessons — OSPF Configuration","url":"https://networklessons.com/cisco/ccna-200-301/basic-ospf-configuration","desc":"network command, interface method, router-id, wildcard masks"},
      {"type":"article","title":"NetworkLessons — OSPF DR/BDR Election","url":"https://networklessons.com/cisco/ccna-200-301/ospf-drbdr-election-explained","desc":"How priority and router-id determine DR/BDR roles"},
      {"type":"article","title":"NetworkLessons — OSPF Neighbor Discovery","url":"https://networklessons.com/cisco/ccna-200-301/ospf-packets-and-neighbor-discovery","desc":"Hello packets, Dead intervals, adjacency requirements"},
  ...
  "3.4.f": {
    ...
    resources: [
      {"type":"video","title":"OSPF Explained","url":"https://www.youtube.com/watch?v=kfvJ8QVJscc","desc":"Passive interface — stops Hellos but still advertises network"},
      {"type":"article","title":"NetworkLessons — OSPF Explained","url":"https://networklessons.com/cisco/ccna-200-301/open-shortest-path-first-ospf-explained","desc":"OSPF overview, areas, LSAs, adjacency formation"},
      {"type":"article","title":"NetworkLessons — OSPF Configuration","url":"https://networklessons.com/cisco/ccna-200-301/basic-ospf-configuration","desc":"network command, interface method, router-id, wildcard masks"},
      {"type":"article","title":"NetworkLessons — OSPF DR/BDR Election","url":"https://networklessons.com/cisco/ccna-200-301/ospf-drbdr-election-explained","desc":"How priority and router-id determine DR/BDR roles"},
      {"type":"article","title":"NetworkLessons — OSPF Neighbor Discovery","url":"https://networklessons.com/cisco/ccna-200-301/ospf-packets-and-neighbor-discovery","desc":"Hello packets, Dead intervals, adjacency requirements"},
  ...
  "3.4.g": {
    ...
    resources: [
      {"type":"video","title":"OSPF Explained","url":"https://www.youtube.com/watch?v=kfvJ8QVJscc","desc":"OSPF cost — reference BW / interface BW"},
      {"type":"article","title":"NetworkLessons — OSPF Explained","url":"https://networklessons.com/cisco/ccna-200-301/open-shortest-path-first-ospf-explained","desc":"OSPF overview, areas, LSAs, adjacency formation"},
      {"type":"article","title":"NetworkLessons — OSPF Configuration","url":"https://networklessons.com/cisco/ccna-200-301/basic-ospf-configuration","desc":"network command, interface method, router-id, wildcard masks"},
      {"type":"article","title":"NetworkLessons — OSPF DR/BDR Election","url":"https://networklessons.com/cisco/ccna-200-301/ospf-drbdr-election-explained","desc":"How priority and router-id determine DR/BDR roles"},
      {"type":"article","title":"NetworkLessons — OSPF Neighbor Discovery","url":"https://networklessons.com/cisco/ccna-200-301/ospf-packets-and-neighbor-discovery","desc":"Hello packets, Dead intervals, adjacency requirements"},
  ...
  "3.4.h": {
    ...
    resources: [
      {"type":"video","title":"OSPF Explained","url":"https://www.youtube.com/watch?v=kfvJ8QVJscc","desc":"Default route — default-information originate"},
      {"type":"article","title":"NetworkLessons — OSPF Explained","url":"https://networklessons.com/cisco/ccna-200-301/open-shortest-path-first-ospf-explained","desc":"OSPF overview, areas, LSAs, adjacency formation"},
      {"type":"article","title":"NetworkLessons — OSPF Configuration","url":"https://networklessons.com/cisco/ccna-200-301/basic-ospf-configuration","desc":"network command, interface method, router-id, wildcard masks"},
      {"type":"article","title":"NetworkLessons — OSPF DR/BDR Election","url":"https://networklessons.com/cisco/ccna-200-301/ospf-drbdr-election-explained","desc":"How priority and router-id determine DR/BDR roles"},
      {"type":"article","title":"NetworkLessons — OSPF Neighbor Discovery","url":"https://networklessons.com/cisco/ccna-200-301/ospf-packets-and-neighbor-discovery","desc":"Hello packets, Dead intervals, adjacency requirements"},
  ...
  "3.4.i": {
    ...
    resources: [
      {"type":"video","title":"OSPF Explained","url":"https://www.youtube.com/watch?v=kfvJ8QVJscc","desc":"Verify — show ip ospf neighbor, show ip route ospf"},
      {"type":"article","title":"NetworkLessons — OSPF Explained","url":"https://networklessons.com/cisco/ccna-200-301/open-shortest-path-first-ospf-explained","desc":"OSPF overview, areas, LSAs, adjacency formation"},
      {"type":"article","title":"NetworkLessons — OSPF Configuration","url":"https://networklessons.com/cisco/ccna-200-301/basic-ospf-configuration","desc":"network command, interface method, router-id, wildcard masks"},
      {"type":"article","title":"NetworkLessons — OSPF DR/BDR Election","url":"https://networklessons.com/cisco/ccna-200-301/ospf-drbdr-election-explained","desc":"How priority and router-id determine DR/BDR roles"},
      {"type":"article","title":"NetworkLessons — OSPF Neighbor Discovery","url":"https://networklessons.com/cisco/ccna-200-301/ospf-packets-and-neighbor-discovery","desc":"Hello packets, Dead intervals, adjacency requirements"},
  ...
  "3.5.a": {
    ...
    resources: [
      {"type":"video","title":"Reading the Routing Table","url":"https://www.youtube.com/watch?v=jLln6BDMEBk","desc":"FHRP purpose — virtual default gateway for failover"},
      {"type":"article","title":"NetworkLessons — Gateway Redundancy (FHRP)","url":"https://networklessons.com/cisco/ccna-200-301/introduction-gateway-redundancy","desc":"HSRP, VRRP, GLBP — virtual gateway redundancy protocols"}
    ],
    labs: [],
  ...
  "3.5.b": {
    ...
    resources: [
      {"type":"video","title":"Reading the Routing Table","url":"https://www.youtube.com/watch?v=jLln6BDMEBk","desc":"HSRP — active/standby, virtual IP and MAC"},
      {"type":"article","title":"NetworkLessons — Gateway Redundancy (FHRP)","url":"https://networklessons.com/cisco/ccna-200-301/introduction-gateway-redundancy","desc":"HSRP, VRRP, GLBP — virtual gateway redundancy protocols"}
    ],
  ...
  "3.5.c": {
    ...
    resources: [
      {"type":"video","title":"Reading the Routing Table","url":"https://www.youtube.com/watch?v=jLln6BDMEBk","desc":"HSRPv2 — IPv6 support, updated virtual MAC format"},
      {"type":"article","title":"NetworkLessons — Gateway Redundancy (FHRP)","url":"https://networklessons.com/cisco/ccna-200-301/introduction-gateway-redundancy","desc":"HSRP, VRRP, GLBP — virtual gateway redundancy protocols"}
    ],
    labs: [],
  ...
  "3.5.d": {
    ...
    resources: [
      {"type":"video","title":"Reading the Routing Table","url":"https://www.youtube.com/watch?v=jLln6BDMEBk","desc":"VRRP — open standard, master/backup roles"},
      {"type":"article","title":"NetworkLessons — Gateway Redundancy (FHRP)","url":"https://networklessons.com/cisco/ccna-200-301/introduction-gateway-redundancy","desc":"HSRP, VRRP, GLBP — virtual gateway redundancy protocols"}
    ],
    labs: [],
  ...
  "3.5.e": {
    ...
    prereqs: [{ name: "FHRP purpose", obj: "3.5.a" }, { name: "HSRP", obj: "3.5.b" }],
    resources: [
      {"type":"video","title":"Reading the Routing Table","url":"https://www.youtube.com/watch?v=jLln6BDMEBk","desc":"GLBP — load balancing across multiple routers"},
      {"type":"article","title":"NetworkLessons — Gateway Redundancy (FHRP)","url":"https://networklessons.com/cisco/ccna-200-301/introduction-gateway-redundancy","desc":"HSRP, VRRP, GLBP — virtual gateway redundancy protocols"}
    ],
    labs: [],
  ...
  "3.5.f": {
    ...
    resources: [
      {"type":"video","title":"Reading the Routing Table","url":"https://www.youtube.com/watch?v=jLln6BDMEBk","desc":"Preemption — higher-priority router reclaims active role"},
      {"type":"article","title":"NetworkLessons — Gateway Redundancy (FHRP)","url":"https://networklessons.com/cisco/ccna-200-301/introduction-gateway-redundancy","desc":"HSRP, VRRP, GLBP — virtual gateway redundancy protocols"}
    ],
    labs: [],
  ...
  "4.1.a": {
    ...
    resources: [
      {"type":"video","title":"TCP vs UDP","url":"https://www.youtube.com/watch?v=uwoD5YsGACg","desc":"NAT terminology — inside local/global, outside local/global"},
      {"type":"article","title":"NetworkLessons — NAT and PAT Introduction","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-nat-and-pat","desc":"NAT terminology, static/dynamic NAT, PAT overload"},
      {"type":"article","title":"NetworkLessons — Static NAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-static-nat-on-cisco-ios-router","desc":"One-to-one NAT with inside/outside interface designations"},
      {"type":"article","title":"NetworkLessons — PAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-pat-on-cisco-ios-router","desc":"Port Address Translation (overload) — many-to-one mapping"}
    ],
    labs: [],
  ...
  "4.1.b": {
    ...
    resources: [
      {"type":"video","title":"Private IP Addresses","url":"https://www.youtube.com/watch?v=po8ZFG0Xc4Q","desc":"Static NAT — one-to-one mapping"},
      {"type":"article","title":"NetworkLessons — NAT and PAT Introduction","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-nat-and-pat","desc":"NAT terminology, static/dynamic NAT, PAT overload"},
      {"type":"article","title":"NetworkLessons — Static NAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-static-nat-on-cisco-ios-router","desc":"One-to-one NAT with inside/outside interface designations"},
      {"type":"article","title":"NetworkLessons — PAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-pat-on-cisco-ios-router","desc":"Port Address Translation (overload) — many-to-one mapping"}
    ],
  ...
  "4.1.c": {
    ...
    resources: [
      {"type":"video","title":"Private IP Addresses","url":"https://www.youtube.com/watch?v=po8ZFG0Xc4Q","desc":"Dynamic NAT — pool-based many-to-many mapping"},
      {"type":"article","title":"NetworkLessons — NAT and PAT Introduction","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-nat-and-pat","desc":"NAT terminology, static/dynamic NAT, PAT overload"},
      {"type":"article","title":"NetworkLessons — Static NAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-static-nat-on-cisco-ios-router","desc":"One-to-one NAT with inside/outside interface designations"},
      {"type":"article","title":"NetworkLessons — PAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-pat-on-cisco-ios-router","desc":"Port Address Translation (overload) — many-to-one mapping"}
    ],
  ...
  "4.1.d": {
    ...
    resources: [
      {"type":"video","title":"Private IP Addresses","url":"https://www.youtube.com/watch?v=po8ZFG0Xc4Q","desc":"PAT (overload) — many-to-one via port numbers"},
      {"type":"article","title":"NetworkLessons — NAT and PAT Introduction","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-nat-and-pat","desc":"NAT terminology, static/dynamic NAT, PAT overload"},
      {"type":"article","title":"NetworkLessons — Static NAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-static-nat-on-cisco-ios-router","desc":"One-to-one NAT with inside/outside interface designations"},
      {"type":"article","title":"NetworkLessons — PAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-pat-on-cisco-ios-router","desc":"Port Address Translation (overload) — many-to-one mapping"}
    ],
  ...
  "4.1.e": {
    ...
    prereqs: [{ name: "NAT terminology", obj: "4.1.a" }],
    resources: [
      {"type":"video","title":"Private IP Addresses","url":"https://www.youtube.com/watch?v=po8ZFG0Xc4Q","desc":"ip nat inside/outside — interface designations"},
      {"type":"article","title":"NetworkLessons — NAT and PAT Introduction","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-nat-and-pat","desc":"NAT terminology, static/dynamic NAT, PAT overload"},
      {"type":"article","title":"NetworkLessons — Static NAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-static-nat-on-cisco-ios-router","desc":"One-to-one NAT with inside/outside interface designations"},
      {"type":"article","title":"NetworkLessons — PAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-pat-on-cisco-ios-router","desc":"Port Address Translation (overload) — many-to-one mapping"}
    ],
  ...
  "4.1.f": {
    ...
    resources: [
      {"type":"video","title":"Private IP Addresses","url":"https://www.youtube.com/watch?v=po8ZFG0Xc4Q","desc":"ACL for NAT — which hosts get translated"},
      {"type":"article","title":"NetworkLessons — NAT and PAT Introduction","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-nat-and-pat","desc":"NAT terminology, static/dynamic NAT, PAT overload"},
      {"type":"article","title":"NetworkLessons — Static NAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-static-nat-on-cisco-ios-router","desc":"One-to-one NAT with inside/outside interface designations"},
      {"type":"article","title":"NetworkLessons — PAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-pat-on-cisco-ios-router","desc":"Port Address Translation (overload) — many-to-one mapping"}
    ],
  ...
  "4.1.g": {
    ...
    resources: [
      {"type":"video","title":"Private IP Addresses","url":"https://www.youtube.com/watch?v=po8ZFG0Xc4Q","desc":"show ip nat translations, show ip nat statistics"},
      {"type":"article","title":"NetworkLessons — NAT and PAT Introduction","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-nat-and-pat","desc":"NAT terminology, static/dynamic NAT, PAT overload"},
      {"type":"article","title":"NetworkLessons — Static NAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-static-nat-on-cisco-ios-router","desc":"One-to-one NAT with inside/outside interface designations"},
      {"type":"article","title":"NetworkLessons — PAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-pat-on-cisco-ios-router","desc":"Port Address Translation (overload) — many-to-one mapping"}
    ],
  ...
  "4.1.h": {
    ...
    resources: [
      {"type":"video","title":"Private IP Addresses","url":"https://www.youtube.com/watch?v=po8ZFG0Xc4Q","desc":"debug ip nat, clear ip nat translation *"},
      {"type":"article","title":"NetworkLessons — NAT and PAT Introduction","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-nat-and-pat","desc":"NAT terminology, static/dynamic NAT, PAT overload"},
      {"type":"article","title":"NetworkLessons — Static NAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-static-nat-on-cisco-ios-router","desc":"One-to-one NAT with inside/outside interface designations"},
      {"type":"article","title":"NetworkLessons — PAT Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-pat-on-cisco-ios-router","desc":"Port Address Translation (overload) — many-to-one mapping"}
    ],
  ...
  "4.2.a": {
    ...
    prereqs: [],
    resources: [
      {"type":"article","title":"NetworkLessons — NTP Configuration","url":"https://networklessons.com/cisco/ccna-200-301/cisco-network-time-protocol-ntp","desc":"NTP client/server/master, stratum levels, authentication"}
    ],
    labs: [],
  ...
  "4.3.a": {
    ...
    resources: [
      {"type":"article","title":"NetworkLessons — Introduction to DNS","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-dns","desc":"DNS hierarchy, record types (A, AAAA, CNAME, MX, PTR), resolution"},
      {"type":"article","title":"NetworkLessons — Introduction to DHCP","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-dhcp","desc":"DORA process, lease renewal, DHCP options and configuration"}
    ],
  ...
  "4.4.a": {
    ...
    resources: [
      {"type":"article","title":"NetworkLessons — Introduction to SNMP","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-snmp","desc":"SNMP architecture, versions (v2c, v3), MIB, traps, security levels"},
      {"type":"article","title":"NetworkLessons — SNMPv3 Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-snmpv3-on-cisco-ios-router","desc":"SNMPv3 with authentication and encryption — the secure way"}
    ],
    labs: [],
  ...
  "4.5.a": {
    ...
    prereqs: [],
    resources: [
      {"type":"video","title":"Troubleshooting Interface Errors","url":"https://www.youtube.com/watch?v=gXnKasnLsP8","desc":"Syslog Level 0 — Emergency: system unusable"},
      {"type":"article","title":"NetworkLessons — Syslog Messages","url":"https://networklessons.com/cisco/ccna-200-301/cisco-ios-syslog-messages","desc":"Severity levels 0-7, logging destinations, message format"}
    ],
    labs: [],
  ...
  "4.5.b": {
    ...
    prereqs: [],
    resources: [
      {"type":"video","title":"Troubleshooting Interface Errors","url":"https://www.youtube.com/watch?v=gXnKasnLsP8","desc":"Syslog Level 1 — Alert: immediate action needed"},
      {"type":"article","title":"NetworkLessons — Syslog Messages","url":"https://networklessons.com/cisco/ccna-200-301/cisco-ios-syslog-messages","desc":"Severity levels 0-7, logging destinations, message format"}
    ],
    labs: [],
  ...
  "4.5.c": {
    ...
    prereqs: [],
    resources: [
      {"type":"video","title":"Troubleshooting Interface Errors","url":"https://www.youtube.com/watch?v=gXnKasnLsP8","desc":"Syslog Level 2 — Critical conditions"},
      {"type":"article","title":"NetworkLessons — Syslog Messages","url":"https://networklessons.com/cisco/ccna-200-301/cisco-ios-syslog-messages","desc":"Severity levels 0-7, logging destinations, message format"}
    ],
    labs: [],
  ...
  "4.5.d": {
    ...
    prereqs: [],
    resources: [
      {"type":"video","title":"Troubleshooting Interface Errors","url":"https://www.youtube.com/watch?v=gXnKasnLsP8","desc":"Syslog Level 3 — Error conditions"},
      {"type":"article","title":"NetworkLessons — Syslog Messages","url":"https://networklessons.com/cisco/ccna-200-301/cisco-ios-syslog-messages","desc":"Severity levels 0-7, logging destinations, message format"}
    ],
    labs: [],
  ...
  "4.5.e": {
    ...
    prereqs: [],
    resources: [
      {"type":"video","title":"Troubleshooting Interface Errors","url":"https://www.youtube.com/watch?v=gXnKasnLsP8","desc":"Syslog Level 4 — Warning conditions"},
      {"type":"article","title":"NetworkLessons — Syslog Messages","url":"https://networklessons.com/cisco/ccna-200-301/cisco-ios-syslog-messages","desc":"Severity levels 0-7, logging destinations, message format"}
    ],
    labs: [],
  ...
  "4.5.f": {
    ...
    prereqs: [],
    resources: [
      {"type":"video","title":"Troubleshooting Interface Errors","url":"https://www.youtube.com/watch?v=gXnKasnLsP8","desc":"Syslog Level 5 — Notification: normal but significant"},
      {"type":"article","title":"NetworkLessons — Syslog Messages","url":"https://networklessons.com/cisco/ccna-200-301/cisco-ios-syslog-messages","desc":"Severity levels 0-7, logging destinations, message format"}
    ],
    labs: [],
  ...
  "4.5.g": {
    ...
    prereqs: [],
    resources: [
      {"type":"video","title":"Troubleshooting Interface Errors","url":"https://www.youtube.com/watch?v=gXnKasnLsP8","desc":"Syslog Level 6 — Informational messages"},
      {"type":"article","title":"NetworkLessons — Syslog Messages","url":"https://networklessons.com/cisco/ccna-200-301/cisco-ios-syslog-messages","desc":"Severity levels 0-7, logging destinations, message format"}
    ],
    labs: [],
  ...
  "4.5.h": {
    ...
    prereqs: [],
    resources: [
      {"type":"video","title":"Troubleshooting Interface Errors","url":"https://www.youtube.com/watch?v=gXnKasnLsP8","desc":"Syslog Level 7 — Debugging messages"},
      {"type":"article","title":"NetworkLessons — Syslog Messages","url":"https://networklessons.com/cisco/ccna-200-301/cisco-ios-syslog-messages","desc":"Severity levels 0-7, logging destinations, message format"}
    ],
    labs: [],
  ...
  "4.5.i": {
    ...
    prereqs: [],
    resources: [
      {"type":"video","title":"Troubleshooting Interface Errors","url":"https://www.youtube.com/watch?v=gXnKasnLsP8","desc":"Mnemonic: Every Awesome Cisco Engineer Will Need Ice cream Daily"},
      {"type":"article","title":"NetworkLessons — Syslog Messages","url":"https://networklessons.com/cisco/ccna-200-301/cisco-ios-syslog-messages","desc":"Severity levels 0-7, logging destinations, message format"}
    ],
    labs: [],
  ...
  "4.5.j": {
    ...
    prereqs: [],
    resources: [
      {"type":"video","title":"Troubleshooting Interface Errors","url":"https://www.youtube.com/watch?v=gXnKasnLsP8","desc":"Logging destinations — console, monitor, buffer, syslog server"},
      {"type":"article","title":"NetworkLessons — Syslog Messages","url":"https://networklessons.com/cisco/ccna-200-301/cisco-ios-syslog-messages","desc":"Severity levels 0-7, logging destinations, message format"}
    ],
    labs: [],
  ...
  "4.5.k": {
    ...
    resources: [
      {"type":"video","title":"Troubleshooting Interface Errors","url":"https://www.youtube.com/watch?v=gXnKasnLsP8","desc":"logging host, logging trap, logging buffered commands"},
      {"type":"article","title":"NetworkLessons — Syslog Messages","url":"https://networklessons.com/cisco/ccna-200-301/cisco-ios-syslog-messages","desc":"Severity levels 0-7, logging destinations, message format"}
    ],
  ...
  "4.6.a": {
    ...
    prereqs: [{ name: "DHCP DORA", obj: "4.3.a" }],
    resources: [
      {"type":"article","title":"NetworkLessons — DHCP Server Configuration","url":"https://networklessons.com/cisco/ccna-200-301/how-to-configure-dhcp-server-on-cisco-ios","desc":"DHCP pool, excluded addresses, default-router, dns-server"},
      {"type":"article","title":"NetworkLessons — DHCP Relay Agent","url":"https://networklessons.com/cisco/ccna-200-301/cisco-ios-dhcp-relay-agent","desc":"ip helper-address — forwarding DHCP across subnet boundaries"}
    ],
    labs: [],
  ...
  "4.7.a": {
    ...
    resources: [
      {"type":"article","title":"NetworkLessons — Introduction to QoS","url":"https://networklessons.com/cisco/ccna-200-301/introduction-qos-quality-service","desc":"Classification, marking, queuing, congestion, policing, shaping"},
      {"type":"article","title":"NetworkLessons — DSCP Values","url":"https://networklessons.com/cisco/ccna-200-301/ip-precedence-dscp-values","desc":"DSCP markings — EF, AF classes, CS values, default BE"},
      {"type":"article","title":"NetworkLessons — Traffic Shaping vs Policing","url":"https://networklessons.com/cisco/ccna-200-301/qos-traffic-shaping-explained","desc":"Shaping buffers excess traffic; policing drops it immediately"}
    ],
    labs: [],
  ...
  "4.8.a": {
    ...
    prereqs: [],
    resources: [
      {"type":"article","title":"NetworkLessons — Configure SSH on Cisco IOS","url":"https://networklessons.com/cisco/ccna-200-301/configure-ssh-cisco-ios","desc":"Complete SSH setup — hostname, domain, RSA keys, VTY lines"}
    ],
    labs: [],
  ...
  "4.9.a": {
    ...
    prereqs: [{ name: "UDP", obj: "1.5" }],
    resources: [
      {"type":"article","title":"NetworkLessons — Cisco IOS Filesystem","url":"https://networklessons.com/cisco/ccna-200-301/cisco-ios-filesystem","desc":"Flash, NVRAM, TFTP/FTP file transfers, IOS image management"},
      {"type":"article","title":"NetworkLessons — Upgrade Cisco IOS","url":"https://networklessons.com/cisco/ccna-200-301/upgrade-cisco-ios-image","desc":"Copy IOS via TFTP/FTP, backup/restore configurations"}
    ],
    labs: [],
  ...
  "5.5.i": { difficulty: 25, studyTime: 10, examFreq: 25, why: "Transport mode encrypts payload only, keeps original IP header. Used for host-to-host. Contrast with tunnel mode.", ciscoIntent: "Describe IPsec transport mode and compare to tunnel", cheatSheet: [{ heading: "Transport Mode", items: ["Encrypts payload ONLY — original IP header is left intact", "Less overhead than tunnel mode (no extra IP header)", "Used for host-to-host communication (e.g., server to server on same LAN)", "Original source/destination IPs are visible (not hidden)", "Typically used with L2TP/IPsec for remote access VPNs", "Tunnel mode = encrypts everything + new header. Transport mode = encrypts payload only."] }], prereqs: [{ name: "Tunnel mode", obj: "5.5.h" }], resources: [
      {"type":"article","title":"NetworkLessons — Introduction to VPNs","url":"https://networklessons.com/cisco/ccna-200-301/introduction-to-vpns","desc":"IPsec, site-to-site vs remote access, AH vs ESP, IKE phases"}
    ], labs: [], vocab: [{ term: "Transport vs Tunnel", q: "Which IPsec mode leaves the original IP header unencrypted?", options: ["Tunnel mode", "Transport mode", "Both encrypt the IP header", "Neither encrypts the IP header"], answer: 1, explain: "Transport mode encrypts only the payload. The original IP header stays intact and visible." }] },
  ...
  "6.7.a": { difficulty: 10, studyTime: 8, examFreq: 30, why: "JSON objects use curly braces with key-value pairs. Keys MUST be double-quoted strings.", ciscoIntent: "Identify JSON object syntax", cheatSheet: [{ heading: "JSON Object", items: ["Enclosed in curly braces: <code>{ }</code>", "Contains key-value pairs separated by commas", "Keys MUST be double-quoted strings: <code>\"name\": \"Router1\"</code>", "Values can be: string, number, boolean, null, object, or array", "Example: <code>{\"hostname\": \"SW1\", \"vlans\": 24, \"managed\": true}</code>", "Order of keys does not matter in JSON objects", "Empty object: <code>{}</code>"] }], prereqs: [], resources: [
      {"type":"article","title":"NetworkLessons — Data Models and Structures","url":"https://networklessons.com/cisco/ccna-200-301/data-models-and-structures","desc":"JSON objects, arrays, nesting, data types, valid vs invalid syntax"}
    ], labs: [], vocab: [{ term: "JSON object", q: "Which is a valid JSON object?", options: ["<code>{'name': 'Router1'}</code>", "<code>{\"name\": \"Router1\"}</code>", "<code>[\"name\": \"Router1\"]</code>", "<code>(name: Router1)</code>"], answer: 1, explain: "JSON requires double quotes for keys and string values. Single quotes are invalid. Square brackets are for arrays, not objects." }] },
  ...
  "6.7.b": { difficulty: 10, studyTime: 8, examFreq: 25, why: "JSON arrays use square brackets for ordered lists. Know the visual difference from objects (curly braces).", ciscoIntent: "Identify JSON array syntax", cheatSheet: [{ heading: "JSON Array", items: ["Enclosed in square brackets: <code>[ ]</code>", "Ordered list of values separated by commas", "Values can be any JSON type: strings, numbers, objects, other arrays", "Example: <code>[\"VLAN10\", \"VLAN20\", \"VLAN30\"]</code>", "Array of objects: <code>[{\"id\": 10}, {\"id\": 20}]</code>", "Accessed by index (zero-based): array[0] = first element", "Empty array: <code>[]</code>"] }], prereqs: [], resources: [
      {"type":"article","title":"NetworkLessons — Data Models and Structures","url":"https://networklessons.com/cisco/ccna-200-301/data-models-and-structures","desc":"JSON objects, arrays, nesting, data types, valid vs invalid syntax"}
    ], labs: [], vocab: [{ term: "JSON array", q: "Which represents a valid JSON array?", options: ["<code>{\"items\": \"a\", \"b\"}</code>", "<code>[\"a\", \"b\", \"c\"]</code>", "<code>(a, b, c)</code>", "<code>&lt;items&gt;a,b,c&lt;/items&gt;</code>"], answer: 1, explain: "JSON arrays use square brackets with comma-separated values. Curly braces = objects. Angle brackets = XML." }] },

  "6.7.c": { difficulty: 10, studyTime: 8, examFreq: 25, why: "Know the 6 JSON data types. String, number, boolean, null, object, array. Numbers have no quotes.", ciscoIntent: "Identify JSON data types", cheatSheet: [{ heading: "JSON Data Types", items: ["String: <code>\"hello\"</code> — always in double quotes", "Number: <code>42</code>, <code>3.14</code>, <code>-7</code> — no quotes, can be integer or float", "Boolean: <code>true</code> or <code>false</code> — lowercase, no quotes", "Null: <code>null</code> — represents empty/no value, lowercase, no quotes", "Object: <code>{\"key\": \"value\"}</code> — nested key-value pair", "Array: <code>[1, 2, 3]</code> — ordered list", "No date type — dates are stored as strings: <code>\"2026-04-14\"</code>"] }], prereqs: [], resources: [
      {"type":"article","title":"NetworkLessons — Data Models and Structures","url":"https://networklessons.com/cisco/ccna-200-301/data-models-and-structures","desc":"JSON objects, arrays, nesting, data types, valid vs invalid syntax"}
    ], labs: [], vocab: [{ term: "JSON types", q: "In JSON, how is a boolean value represented?", options: ["<code>\"true\"</code> (string with quotes)", "<code>True</code> (capitalized)", "<code>true</code> (lowercase, no quotes)", "<code>1</code> (number)"], answer: 2, explain: "JSON booleans are lowercase with no quotes: true or false. \"true\" with quotes would be a string, not a boolean." }] },

  "6.7.d": { difficulty: 15, studyTime: 10, examFreq: 25, why: "Nesting is how real API responses look. Objects inside objects, arrays inside objects, etc.", ciscoIntent: "Read and interpret nested JSON structures", cheatSheet: [{ heading: "JSON Nesting", items: ["Objects can contain other objects: <code>{\"device\": {\"name\": \"R1\", \"ip\": \"10.1.1.1\"}}</code>", "Objects can contain arrays: <code>{\"vlans\": [10, 20, 30]}</code>", "Arrays can contain objects: <code>[{\"id\": 1}, {\"id\": 2}]</code>", "Deeply nested: <code>{\"site\": {\"devices\": [{\"name\": \"SW1\", \"ports\": [1, 2, 3]}]}}</code>", "Access nested values with dot/bracket notation: <code>data.site.devices[0].name</code> → \"SW1\"", "API responses are typically nested JSON — devices containing interfaces containing IPs", "Exam may show nested JSON and ask 'what is the value of X?'"] }], prereqs: [{ name: "JSON objects", obj: "6.7.a" }, { name: "JSON arrays", obj: "6.7.b" }], resources: [
      {"type":"article","title":"NetworkLessons — Data Models and Structures","url":"https://networklessons.com/cisco/ccna-200-301/data-models-and-structures","desc":"JSON objects, arrays, nesting, data types, valid vs invalid syntax"}
    ], labs: [{ name: "Parse nested JSON", desc: "Given API response, extract hostname, IP, VLAN list" }], vocab: [{ term: "Nesting", q: "Given: <code>{\"router\": {\"interfaces\": [\"Gi0/0\", \"Gi0/1\"]}}</code> — what is router.interfaces[1]?", options: ["Gi0/0", "Gi0/1", "router", "interfaces"], answer: 1, explain: "router.interfaces is the array [\"Gi0/0\", \"Gi0/1\"]. Index [1] = second element = \"Gi0/1\". Arrays are zero-indexed." }] },

  "6.7.e": { difficulty: 10, studyTime: 8, examFreq: 30, why: "Common JSON syntax traps on the exam: single quotes invalid, trailing commas invalid, no comments allowed.", ciscoIntent: "Identify valid vs invalid JSON syntax", cheatSheet: [{ heading: "Valid vs Invalid JSON", items: ["MUST use double quotes for keys and strings — single quotes are INVALID", "No trailing commas: <code>{\"a\": 1, \"b\": 2,}</code> ← INVALID (trailing comma after 2)", "No comments allowed — JSON has no comment syntax (// and /* */ are invalid)", "Keys must be strings: <code>{name: \"R1\"}</code> ← INVALID (unquoted key)", "Values must be valid types — no undefined, no functions", "Valid: <code>{\"name\": \"R1\", \"active\": true, \"ports\": null}</code>", "Invalid: <code>{'name': 'R1'}</code> — single quotes not allowed in JSON"] }], prereqs: [], resources: [
      {"type":"article","title":"NetworkLessons — Data Models and Structures","url":"https://networklessons.com/cisco/ccna-200-301/data-models-and-structures","desc":"JSON objects, arrays, nesting, data types, valid vs invalid syntax"}
    ], labs: [], vocab: [{ term: "JSON validity", q: "Which JSON is INVALID?", options: ["<code>{\"name\": \"R1\"}</code>", "<code>{\"count\": 5}</code>", "<code>{\"name\": \"R1\",}</code>", "<code>{\"active\": true}</code>"], answer: 2, explain: "Trailing comma after the last key-value pair is invalid JSON. The comma after \"R1\" has no next element." }] },
