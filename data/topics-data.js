  ...
  "domains": [
    {
      ...
      "topics": [
        ...
        },
        {
          ...
          "subtopics": [
            { "id": "1.2.a", "name": "Two-tier" },
            { "id": "1.2.b", "name": "Three-tier" },
            { "id": "1.2.c", "name": "Spine-leaf" },
            { "id": "1.2.d", "name": "WAN" },
        ...
        },
        {
          ...
          "subtopics": [
            { "id": "1.9.a", "name": "Unicast (global, unique local, and link local)" },
            { "id": "1.9.b", "name": "Anycast" },
            { "id": "1.9.c", "name": "Multicast" },
            { "id": "1.9.d", "name": "Modified EUI 64" }
          ],
          "resumeRating": "none"
        },
        {
        ...
        },
        {
          ...
          "subtopics": [
            { "id": "1.11.a", "name": "Nonoverlapping Wi-Fi channels" },
            { "id": "1.11.b", "name": "SSID" },
            { "id": "1.11.c", "name": "RF" },
            { "id": "1.11.d", "name": "Encryption" }
          ],
          "resumeRating": "none"
        },
        {
        ...
        },
        {
          ...
          "subtopics": [
            { "id": "1.13.a", "name": "MAC learning and aging" },
            { "id": "1.13.b", "name": "Frame switching" },
            { "id": "1.13.c", "name": "Frame flooding" },
            { "id": "1.13.d", "name": "MAC address table" }
          ],
          "resumeRating": "none"
        }
      ]
      ...
      "topics": [
        {
          ...
          "subtopics": [
            { "id": "2.1.a", "name": "Access ports (data and voice)" },
            { "id": "2.1.b", "name": "Default VLAN" },
            { "id": "2.1.c", "name": "InterVLAN connectivity" }
          ],
          "resumeRating": "none"
        },
        {
          ...
          "subtopics": [
            { "id": "2.2.a", "name": "Trunk ports" },
            { "id": "2.2.b", "name": "802.1Q" },
            { "id": "2.2.c", "name": "Native VLAN" }
          ],
          "resumeRating": "none"
        },
        {
        ...
        },
        {
          ...
          "subtopics": [
            ...
            { "id": "2.5.b", "name": "Port states and roles" },
            { "id": "2.5.c", "name": "PortFast" },
            { "id": "2.5.d", "name": "Root guard, loop guard, BPDU filter, and BPDU guard" }
          ],
          "resumeRating": "none"
        },
        {
      ...
      "topics": [
        {
          ...
          "subtopics": [
            { "id": "3.1.a", "name": "Routing protocol code" },
            { "id": "3.1.b", "name": "Prefix" },
            { "id": "3.1.c", "name": "Network mask" },
            { "id": "3.1.d", "name": "Next hop" },
            { "id": "3.1.e", "name": "Administrative distance" },
            { "id": "3.1.f", "name": "Metric" },
            { "id": "3.1.g", "name": "Gateway of last resort" }
          ],
          "resumeRating": "none"
        },
        {
          ...
          "subtopics": [
            { "id": "3.2.a", "name": "Longest prefix match" },
            { "id": "3.2.b", "name": "Administrative distance" },
            { "id": "3.2.c", "name": "Routing protocol metric" }
          ],
          "resumeRating": "none"
        },
        {
          ...
          "subtopics": [
            { "id": "3.3.a", "name": "Default route" },
            { "id": "3.3.b", "name": "Network route" },
            { "id": "3.3.c", "name": "Host route" },
            { "id": "3.3.d", "name": "Floating static" }
          ],
          "resumeRating": "none"
        },
        {
          ...
          "subtopics": [
            { "id": "3.4.a", "name": "Neighbor adjacencies" },
            { "id": "3.4.b", "name": "Point-to-point" },
            { "id": "3.4.c", "name": "Broadcast (DR/BDR selection)" },
            { "id": "3.4.d", "name": "Router ID" }
          ],
          "resumeRating": "none"
        },
        {
      ...
      "topics": [
        ...
        },
        {
          ...
          "subtopics": [
            ...
            { "id": "6.3.b", "name": "Northbound and Southbound APIs" }
          ],
          "resumeRating": "none"
        },
        {
