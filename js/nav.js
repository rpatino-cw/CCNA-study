...
(function () {
  ...
  var CCNA_NAV = [
    ...
    { text: 'Learn', children: [
      ...
      { text: 'CIDR 3D', href: 'cidr-3d.html' },
    ...
    { text: 'Plan', children: [
      ...
      { text: 'Coverage Matrix', href: 'coverage.html' },
  ...
  beta.innerHTML = '<a href="' + fixHref('changelog.html') + '" class="beta-tag" style="text-decoration:none">ALPHA v4.34.0</a><a href="' + fixHref('bug-report.html') + '" class="beta-bug">Report Bug</a>';
