...
(function () {
  ...
  beta.innerHTML = '<a href="' + fixHref('changelog.html') + '" class="beta-tag" style="text-decoration:none">ALPHA v5.1.2</a><a href="' + fixHref('bug-report.html') + '" class="beta-bug">Report Bug</a>';
